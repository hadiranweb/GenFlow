...
) -> Result<Json<genflow_receptors::GeneratedPositionProfile>, AppError> {
...
pub async fn get_position(
    ...
    Path(_id): Path<Uuid>,
) -> Result<Json<genflow_receptors::JobPosition>, AppError> {
    Err(AppError::NotFound("Position not yet implemented".to_string()))
}
